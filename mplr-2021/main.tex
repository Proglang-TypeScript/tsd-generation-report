...
%%% The following is specific to MPLR '21 and the paper
%%% 'Generation of TypeScript Declaration Files from JavaScript Code'
%%% by Fernando Cristiani and Peter Thiemann.
%%%
\setcopyright{acmlicensed}
\acmPrice{15.00}
\acmDOI{10.1145/3475738.3480941}
\acmYear{2021}
\copyrightyear{2021}
\acmSubmissionID{mplr21main-id6-p}
\acmISBN{978-1-4503-8675-3/21/09}
\acmConference[MPLR '21]{Proceedings of the 18th ACM SIGPLAN International Conference on Managed Programming Languages and Runtimes}{September 29--30, 2021}{Münster, Germany}
\acmBooktitle{Proceedings of the 18th ACM SIGPLAN International Conference on Managed Programming Languages and Runtimes (MPLR '21), September 29--30, 2021, Münster, Germany}
...
\begin{figure}[tp]
  ...
  \caption[dts-generate - Architecture overview]{dts-generate - Architecture
    overview
    % - The initial code base is retrieved from the \NPM{} package's
    % repository.
...
\begin{figure}[tp]
  \begin{centering}
      ...
      \caption[Evaluation against DefinitelyTyped repository]{{Evaluation of
          ...
          % against DefinitelyTyped          repository
        }
        % - The parser
...
\begin{lstlisting}[
  ...
  language=JavaScript,captionpos=b,float=t,numbers=none
  ]
  var smartTruncate = require('smart-truncate');
  var string = 'To iterate is human, to recurse divine.';
  // Append ellipsis at end of the truncated string.
