...
As \texttt{dts-generate} is based on run-time information, code
fragments are needed that import and use the JavaScript library to
obtain run-time information from running the instrumented library
code.
