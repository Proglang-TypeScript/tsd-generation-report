...
\begin{abstract}
  ...
  generated directly from an \NPM{} module and 70 of these were
...
\begin{itemize}
  ...
  \item \url{https://github.com/proglang/ts-declaration-file-generator/tree/v1.2}
  ...
  \item \url{https://github.com/proglang/dts-generate-results/tree/v1.2}
\end{itemize}
...
for 244 modules out of 6029 modules and we identified 70 modules that have only the
...
\begin{figure}[tp]
  ...
  A TypeScript Declaration File was generated for only 244 modules, out of 6029 modules in the DefinitelyTyped Repository. 
...
We analyzed 70 of the 244 generated files. The remaining 174 files contained at least one
