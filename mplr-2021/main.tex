...
globToRegExp : (glob: string, 
                opts: { extended : bool,
                        ...
                        flags?: any }) -> RegExp
\end{verbatim}
After expanding manually the code base with one particular case, we obtain the following type
\begin{verbatim}
...
As the type for \lstinline{glob} and the return type
...
argument so we arrive at a single collapsed candidate type
\begin{verbatim}
globToRegExp : (glob: string, 
                opts?: { extended? : bool,
                         globstar?: bool,
