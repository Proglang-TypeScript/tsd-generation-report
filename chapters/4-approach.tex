...
\todo{What does the developer expect from each operation? How do they use them? Esa es la clave, en realidad la type inference se trata de adinivar lo que quiere hacer el developer y para eso hace falta responder a esas preguntas. Eso se logra con los experiments que se hicieron sobre la info sobre los tipos y los operators.}